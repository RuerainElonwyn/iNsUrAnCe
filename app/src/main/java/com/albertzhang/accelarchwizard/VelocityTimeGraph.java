 ...
 */
public class VelocityTimeGraph extends Fragment{
    ...
    private FileListAdapterVelocity adapter;


    public VelocityTimeGraph() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.fragment_velocity_time_graph, container, false);
        ...
        adapter = new FileListAdapterVelocity(x.getContext());

        recyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(new FileListAdapterVelocity.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                try {
                    ...
                    dataIntegrated = IntegrateTrapeziumAlg(dataIn);

                    if (dataIntegrated.size() > 0) {

                        try {
                            Intent intent = new Intent(VelocityTimeGraph.this.getActivity(), PlotterClassVelocity.class);
                            startActivity(intent);
                        } catch (RuntimeException e) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(VelocityTimeGraph.this.getActivity());
